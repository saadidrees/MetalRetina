...
expFold = 'RGB-8-1-0.48-11111' #'RGB-8-1-0.48-11111'
...
for exp in expList:
    ...
    fname_dataFile = os.path.join(path_dataset,(expDate+'_dataset_'+STIM+'_'+str(t_frame)+'ms_sig-'+str(sig)+file_suffix+'.h5'))
    ...
    for dataset in datasetsToLoad:
        ...
        fname_data_train_val_test = os.path.join(path_save,(expDate+'_dataset_train_val_test_'+STIM+'_'+dataset+'_'+D_TYPE+'_'+str(t_frame)+'ms_sig-'+str(sig)+file_suffix+'_MAPS.h5'))
        if 1: #not os.path.exists(fname_data_train_val_test):
            ...
            # save_h5Dataset(fname_data_train_val_test,data_train,data_val,data_test,data_quality,dataset_rr,parameters,resp_orig=resp_orig,dtype=D_TYPE)
            data_handler_ej.save_info_unitSplit(fname_data_train_val_test,info_unitSplit)
...
for exp in expList:
    ...
    for dataset in datasetsToLoad:
        ...
        info_unitSplit = data_handler_ej.load_info_unitSplit(fname_data_train_val_test)
